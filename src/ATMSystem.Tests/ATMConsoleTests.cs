...
namespace ATMSystem.Tests
{
    ...
    public class ATMConsoleTests
    {
        ...
        {
            // Arrange
            var account = new Account(1, "customer", "12345", "Test Customer", 1000m, "Active");
        ...
        {
            // Arrange
            var account = new Account(1, "admin", "12345", "Test Admin", 1000m, "Admin");
        ...
        {
            // Arrange
            var updatedAccount = new Account(1, "test", "12345", "Test User", 2000m, "Active");
            _mockConsole.ReadLine().Returns(
                "3", // Update Account
                "1", // Account Number
                "2000", // New Balance
